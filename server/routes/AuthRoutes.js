...
// Добавил, потому что иначе возвращается изображение, в оригинале, а мне нужен другой формат, для обработки.
// На твоем коде это никак не сказывается. // Твой код сверху для проверки изминений.